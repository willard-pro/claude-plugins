...
- **Safety gates**: Seven structural invariants (artifact existence, complexity coherence, adversarial review, verification plan derivation, re-approval integrity, remediation brief integrity, PR verdict integrity). Violations emit `|META|gate-stop|fail|<CODE>`.
