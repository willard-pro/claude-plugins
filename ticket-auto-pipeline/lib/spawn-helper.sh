...
spawn_write_env() {
  ...
  for arg in "$@"; do
    case "$arg" in
      ...
      *) echo "spawn_write_env: unknown parameter '$arg'" >&2; return 1 ;;
    esac
  done
...
spawn_agent_pre() {
  ...
  for arg in "$@"; do
    case "$arg" in
      ...
      *) echo "spawn_agent_pre: unknown parameter '$arg'" >&2; return 1 ;;
    esac
  done
...
spawn_agent_post() {
  ...
  for arg in "$@"; do
    case "$arg" in
      ...
      HB_LOG_FILE=*) HB_LOG_FILE="${arg#HB_LOG_FILE=}" ;;
      CLAUDE_LOG_FILE=*) CLAUDE_LOG_FILE="${arg#CLAUDE_LOG_FILE=}" ;;
      *) echo "spawn_agent_post: unknown parameter '$arg'" >&2; return 1 ;;
    esac
  done
...
spawn_capture() {
  ...
  for arg in "$@"; do
    case "$arg" in
      ...
      *) echo "spawn_capture: unknown parameter '$arg'" >&2; return 1 ;;
    esac
  done
